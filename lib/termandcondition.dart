      ...
      home: SafeArea(
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              Container(margin: EdgeInsets.only(top: 20,bottom: 10),child: Text("Terms & Condition",style: TextStyle(
...
\n""",textAlign: TextAlign.center,style: TextStyle(fontFamily: "OpenSansLight",fontSize: 15),),
                        ...
                        Container(padding:EdgeInsets.all(10),child: Text("This app is checked, operated and updated by “Supply- 19” in INDIA. We give no guarantee that the details presented in this app are also correct in places outside India. If you call up this app from a place outside India or download contents, please note that it is your own responsibility to ensure that you act in compliance with local legislation applicable in that place. \n",textAlign: TextAlign.center,style: TextStyle(fontFamily: "OpenSansLight",fontSize: 15),)),
                      ],
                    ),
                  ),
                ),
